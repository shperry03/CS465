...
player1=Hand('AI', table, 'shperry')
player2=Hand('SAMUEL', table, 'SklanskySys2')
player3=Hand('S',table,'Random')
player4=Hand('a',table,'Random')
player5=Hand('m',table,'Random')
player6=Hand('u',table,'Random')
